<?php
// Asegúrate de que $conn esté definido como instancia de mysqli
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Consulta preparada para insertar los datos en la tabla 'secretarios'
    ...
    if ($stmt->execute()) {
        echo json_encode([
            "status" => "success",
            "message" => "Secretario guardado correctamente."
        ]);
    } else {
        echo json_encode([
            "status" => "error",
